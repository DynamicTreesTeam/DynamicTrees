...
//    }
    ...
    protected static RequiredArgumentBuilder<CommandSourceStack, Identifier> resourceLocationArgument(final String name, final Supplier<Collection<Identifier>> suggestionsSupplier) {
