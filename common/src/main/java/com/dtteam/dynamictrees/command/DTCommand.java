...
public final class DTCommand {
    ...
    public DTCommand() {
        ...
        Collections.addAll(this.subCommands, new GetTreeCommand(), new GetRootsCommand(), new GrowPulseCommand(), new KillTreeCommand(), new RegistryCommand(),
                new FertilityCommand(), new SetTreeCommand(), new RotateJoCodeCommand(), new CreateStaffCommand(), new SetCoordXorCommand(), //new CreateTransformPotionCommand(), new TransformCommand(),
                new ClearOrphanedCommand(), new PurgeTreesCommand());
    }
