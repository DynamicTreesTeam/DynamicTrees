...
public interface Growable {
    ...
    enum MatureAction {
         ...
         * Growable#performMatureAction(LevelAccessor, BlockPos, BlockState)}) for the set block.
         */
        DEFAULT((block, info) -> {
        ...
        MatureAction(BiConsumer<Growable, Info> action) {
            this.action = action;
        }

        public void perform(Growable block, Info blockInfo) {
