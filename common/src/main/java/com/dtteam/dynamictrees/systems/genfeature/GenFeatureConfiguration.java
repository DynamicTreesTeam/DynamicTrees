...
public class GenFeatureConfiguration extends Configuration<GenFeatureConfiguration, GenFeature> {
    ...
    /**
     * Invokes {@link GenFeature#generate(GenFeatureConfiguration, GenFeature.Type, GenFeatureContext)} for this configured
     ...
     */
    public <C extends GenFeatureContext, R> R generate(GenFeature.Type<C, R> type, C context) {
