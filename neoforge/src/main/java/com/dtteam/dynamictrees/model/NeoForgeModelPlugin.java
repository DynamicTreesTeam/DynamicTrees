...
public final class NeoForgeModelPlugin {
    ...
    private static Identifier creakingCacheKey(Identifier blockId, BlockState state) {
    ...
    private static void cacheCreakingModels(ModelBaker baker, ModelDebugName debugName,
