...
public class SmallPalmLeavesBakedModel extends PalmLeavesBakedModel {
    ...
    public SmallPalmLeavesBakedModel(ResourceLocation frondsResLoc, Function<Material, TextureAtlasSprite> spriteGetter){
    ...
    public void initModels(){
        for (CoordUtils.Surround surr : CoordUtils.Surround.values()) {
            ...
            BlockVertexData[] quadData = {
                    new BlockVertexData(0, 0, 2, 10/16f, 4/16f),
                    new BlockVertexData(0, 1, 2, 10/16f, 0),
