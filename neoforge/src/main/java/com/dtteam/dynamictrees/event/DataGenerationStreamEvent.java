...
public class DataGenerationStreamEvent extends Event implements IModBusEvent {
    ...
    public DataGenerationStreamEvent(final LootTableSubProvider tableProvider, String modId, Map<ResourceKey<LootTable>, LootTable.Builder> map, HolderLookup.Provider registries) {
        super();
