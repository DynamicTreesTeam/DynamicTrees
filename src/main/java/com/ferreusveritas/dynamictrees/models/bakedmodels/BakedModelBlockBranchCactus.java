...
//			if (coreRadius == 4 && numConnections == 1 && ((BlockState) blockState).getValue(BlockBranchCactus.ORIGIN).getAxis().isHorizontal()) {
//				connections[1] = 4;
//				extraUpSleeve = true;
//			}
//
...
//			}
//			if (extraUpSleeve) {
//				quadsList.addAll(sleeveTopSpikes.getQuads(extendedBlockState, Direction.UP, rand));
//			}
//		}
//
//		return quadsList;
...
//	 * @return
//	 */
//	protected int getConnectionRadius(BlockState iExtendedBlockState, IUnlistedProperty<Integer> whichConnection) {
