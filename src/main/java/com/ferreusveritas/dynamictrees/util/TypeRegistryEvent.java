...
/**
 * Allows for registering {@link TypedRegistry.EntryType} objects to {@link Registry} objects.
 * Subscribers should use {@link #registerType(ResourceLocation, TypedRegistry.EntryType)} to
 * register their {@link TypedRegistry.EntryType} objects, as full access to the {@link Registry}
 * is not given to prevent misuse of this event, for full access to register {@link RegistryEntry}
 * objects, use {@link RegistryEvent}.
 *
...
public final class TypeRegistryEvent<V extends RegistryEntry<V>> extends GenericEvent<V> implements IModBusEvent {
    ...
    /**
     * Registers a custom {@link TypedRegistry.EntryType}, allowing custom sub-classes of the registry entry
