...
public class PoissonDisc extends Vec2i {
    ...
    /**
     * Uses a simple bitmap to detect collisions of raster circles. This variation allows for edge pixels to intersect
     * without creating a collision.
     *
     * @param other The other circle to test against
    ...
    /**
     * Mask off an arc CW in 1/32 increments. From 0 to PI * 2. 0 PI is pointing +X(East) increasing from 0 PI starts
     * toward +Z(South) ⟳
     *
    ...
    /**
     * Detects the transition from 0 to 1 around the circle arc mask in the clockwise direction starting from 0
     * degrees.
     * <p>
    ...
    /**
     * Detects the transition from 0 to 1 around the circle arc mask in the counter clockwise direction starting from 0
     * degrees.
     * <p>
     * If the arc mask is completely empty then the function defaults to a psuedorandom bit from 0 - 31
     *
    ...
    /**
     * Test to see if the circle has any remaining free angles on its arc. A circle with no free angles is considered
     * solved in the circle packing algorithm.
     *
