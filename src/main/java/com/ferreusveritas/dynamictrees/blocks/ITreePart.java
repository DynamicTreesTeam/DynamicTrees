...
public interface ITreePart {
	...
	*/
	int getHydrationLevel(IBlockAccess blockAccess, int x, int y, int z, ForgeDirection dir, DynamicTree leavesTree);
	...
	* @return GrowingTree
	*/
	DynamicTree getTree(IBlockAccess blockAccess, int x, int y, int z);
