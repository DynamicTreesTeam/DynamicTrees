...
/**
 * This class provides a mechanism for mapping leaves sub blocks to their corresponding leaves properties.  This is
 * currently a 4:1 ratio. This method will be obsolete in MC 1.13 since each blockstate will be able to contain it's own
 * leaves properties.
 * <p>
 * The data is only used by mods for initialization purposes and all contained data will be erased during postInit().
 *
...
public class LeavesPaging {
	...
	/**
	 * Get the map of leaves from for the appropriate modid. If the map does not exist then one is created.
	 *
