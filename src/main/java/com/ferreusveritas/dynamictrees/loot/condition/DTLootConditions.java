...
public final class DTLootConditions {
    ...
    public static final LootConditionType SEASONAL_SEED_DROP_CHANCE =
            register("dynamictrees:seasonal_seed_drop_chance", new SeasonalSeedDropChance.Serializer());

    public static final LootConditionType VOLUNTARY_SEED_DROP_CHANCE =
            register("dynamictrees:voluntary_seed_drop_chance", new VoluntarySeedDropChance.Serializer());
