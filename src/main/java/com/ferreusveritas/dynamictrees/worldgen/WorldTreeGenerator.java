...
public class WorldTreeGenerator extends TreeGenerator implements IWorldGenerator {

	public static void preInit() {
		if(WorldGenRegistry.isWorldGenEnabled()) {
			INSTANCE = new WorldTreeGenerator();
		}
	}
	
	public static WorldTreeGenerator getWorldGenerator() {
		return (WorldTreeGenerator) INSTANCE;
	}
