...
public class JsonBiomePropertyApplierDensity implements IJsonBiomeApplier {
	...
	public void apply(BiomeDatabase dbase, JsonElement element, Biome biome) {
		if(element.isJsonObject()) {
			...
			dbase.setDensitySelector(biome, readDensitySelector(object), operation);
		}
	...
	private static IDensitySelector createScaleDensitySelector(@Nullable final JsonArray jsonArray) {
	...
	private static IDensitySelector readDensitySelector(final JsonObject mainObject) {
