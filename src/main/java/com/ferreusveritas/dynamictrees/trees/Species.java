...
//	 * @return
//	 */
//	public boolean isAcceptableSoil(World world, BlockPos pos, BlockState soilBlockState) {
...
//	 */
//	public boolean onTreeActivated(World world, BlockPos rootPos, BlockPos hitPos, BlockState state, EntityPlayer player, EnumHand hand, ItemStack heldItem, Direction side, float hitX, float hitY, float hitZ) {
//
