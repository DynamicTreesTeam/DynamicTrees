...
public class JoCode {
	...
	*/
	public void growTree(World world, GrowingTree tree, int x, int y, int z, ForgeDirection facing, int radius) {
	...
	private int growTreeFork(World world, GrowingTree tree, int pos, int x, int y, int z, boolean disabled) {
